      ...
      int repetition)
    {
      ...
      try
      {
        ...
        return BenchmarkResult.Create(
          ...
          generation.PlacementFailureCount,
          generation.MessageRejectedAttemptCount,
      ...
      catch (OperationCanceledException) when (timeout.IsCancellationRequested)
      {
        ...
        return BenchmarkResult.Create(
          ...
          progress?.PlacementFailureCount ?? 0,
          progress?.MessageRejectedAttemptCount ?? 0,
      ...
      catch (MonteCarloGenerationException exception)
      {
        ...
        return BenchmarkResult.Create(
          ...
          exception.PlacementFailureCount,
          exception.MessageRejectedAttemptCount,
